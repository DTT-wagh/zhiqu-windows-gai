(function () {
  ...
  function findGuestProfileAction() {
    var profileLogin = document.querySelector('[data-zq-guest-profile-login="true"]');
  ...
  function patchGuestProfile() {
    ...
    var loginButton = findGuestProfileAction();
    if (loginButton) {
      loginButton.setAttribute('data-zq-guest-login', 'true');
      loginButton.setAttribute('data-zq-guest-profile-login', 'true');
